...
# Define 'high_risk' based on smoker status and bmi
...
# 3. Data Splitting & Fixing Data Leakage

# --- Prepare Regression Data ---
# Predict charges using all available features
features_regression = encoded_dataset.drop(columns=['charges', 'high_risk'])
target_charges = encoded_dataset['charges']

# --- Prepare Classification Data ---
# Drop 'bmi' and 'smoker_yes' to prevent Data Leakage
